            ...
            <div class="select_vote vote_1 container p-0 mt-sm-10" style="display: nones">
                ...
                <?php if($premiums=="free" || $premiums=="free_paid"){ ?>
                    ...
                    <div class="col-md-12 p-0">
                        <div class="vote_btn vote_btn_free1" caption="free" wallets="">Vote Free 1</div>

                        <div class="vote_btns vote_btn_free2" style="display: none;">Vote Free <span id="count_down" style="display: block; font-size: 14px;"></span></div>
                        <div class="lines"></div>
                    </div>
                    <?php } ?>
                    ...
                    <div class="col-md-12 p-0">
                        ...
                        if($this->myID=="" || $this->myID <= 0)
                            echo '<div class="vote_btns login_vote" style="font-size: 14px;">Login Vote 2</div>';
                        else
                            echo '<div class="vote_btn login_vote1" caption="login_free" wallets="">Login Vote 2</div>';
                        ?>
                        <div class="vote_btns login_vote1i" style="display: none;">Login Vote 2 <span id="count_down2" style="display: block; font-size: 14px;"></span></div>
                        <div class="lines"></div>
                    </div>
                ...
                <p class="expirys mt-10">This contest expires in <b style="color: #09C" class="caption_expire_  <?=$countdowns1?>" id="caption_expire"><?=$expirys;?></b></p>
            </div>
